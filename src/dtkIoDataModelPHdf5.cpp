...
void dtkIoDataModelPHdf5::fileOpen(const QString &file_name, const dtkIoDataModel::FileMode& mode)
{
...
void dtkIoDataModelPHdf5::read(const QString &dataset_name, const dtkIoDataModel::DataType& type, void *values)
{
    switch(type) {
    case dtkIoDataModel::Int:
    {
